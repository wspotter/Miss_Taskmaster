...
/*! @azure/msal-common v15.12.0 2025-09-09 */const Rr={tokenRenewalOffsetSeconds:300,preventCorsPreflight:!1},_r={loggerCallback:()=>{},piiLoggingEnabled:!1,logLevel:e.LogLevel.Info,correlationId:t.EMPTY_STRING},Pr={claimsBasedCachingEnabled:!1},Mr={async sendGetRequestAsync(){throw pt(ct)},async sendPostRequestAsync(){throw pt(ct)}},Or={sku:t.SKU,version:vt,cpu:t.EMPTY_STRING,os:t.EMPTY_STRING},qr={clientSecret:t.EMPTY_STRING,clientAssertion:void 0},Nr={azureCloudInstance:wt.None,tenant:`${t.DEFAULT_COMMON_TENANT}`},Ur={application:{appName:"",appVersion:""}};function Lr(e){return e.authOptions.authority.options.protocolMode===wr.OIDC}
/*! @azure/msal-common v15.12.0 2025-09-09 */const Hr="home_account_id",xr="UPN";
/*! @azure/msal-common v15.12.0 2025-09-09 */function Dr(e,t){if(!e)throw pt(Ie);try{const r=t(e);return JSON.parse(r)}catch(e){throw pt(we)}}function Br(e){if(!e)throw pt(we);const r=e.split(H,2);return{uid:r[0],utid:r.length<2?t.EMPTY_STRING:r[1]}}
/*! @azure/msal-common v15.12.0 2025-09-09 */const Fr="client_id",zr="redirect_uri",Kr="token_type",Gr="req_cnf",$r="return_spa_code",Qr="x-client-xtra-sku",jr="brk_client_id",Wr="brk_redirect_uri",Vr="instance_aware";
/*! @azure/msal-common v15.12.0 2025-09-09 */
